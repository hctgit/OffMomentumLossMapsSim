...
#fileList="*DUMP.txt dist0.dat screenout FirstImpacts.dat first_imp_average.dat LPI_BLP_out.s Coll* Coll_Scatter_real.dat collgaps.dat coll_summary.dat impacts_real.dat"
fileList="LPI* collgaps.dat coll_summary.dat impacts_real.dat"
...
#SixExeCollimat="/afs/cern.ch/user/h/hgarciam/SixTrack/SixTrack/SixTrack_cmakesix_COLLIMAT_DATAMODS_HUGENPART_STF_NOCRLIBM_defaultcompiler_defaultbuildtype/SixTrack_4610_hugenpart_datamods_stf_collimat_fast_tilt_cmake_Linux_gfortran_static_x86_64_64bit" # HEIGENPART sixtrack
#SixExeNonCollimat="/afs/cern.ch/user/h/hgarciam/SixTrack/SixTrack/SixTrack_HUGENPART/SixTrack_4610_hugenpart_datamods_stf_collimat_fast_tilt_cmake_Linux_gfortran_static_x86_64_64bit"
SixExeCollimat="/afs/cern.ch/user/h/hgarciam/SixTrack_old/SixTrack_old/SixTrack" # HEIGENPART sixtrack
SixExeNonCollimat="/afs/cern.ch/user/h/hgarciam/SixTrack_old/SixTrack_old/SixTrack_noCol"
...
fort3lib="/afs/cern.ch/user/h/hgarciam/scratch0/ALFA_studies/HTCondorSimulations/fort_3_lib.sh"
HTCONDORtemplate="/afs/cern.ch/user/h/hgarciam/scratch0/apertureStudiesHL/htcondor.sub"
...
TMParticleGenerator="/afs/cern.ch/user/h/hgarciam/scratch0/off_momentum_studies/startOfRamp/JoelStuff/cern/synchrotron/exportTool"
...
$TMParticleGenerator nocoll . 1 1000 linexp 0
mv 1.txt fort.13
...
python convert_dump_to_input.py ip1_dump.txt coll_input.txt 1000 451209.0195450667524710 # Last number is expected energy after 11 seconds of ramping
...
# reduce coll_ellipse
awk '\$2<-5.' coll_ellipse.dat > coll_ellipseRed.dat

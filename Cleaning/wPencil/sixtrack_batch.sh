...
fileList="LPI_BLP_out.s collgaps.dat coll_summary.dat impacts_real.dat myDist.dat dist0.dat"
...
#SixExe="/afs/cern.ch/user/h/hgarciam/SixTrack/SixTrack/SixTrack/SixTrack_4610_collimat_fast_tilt_cmake_Linux_gfortran_static_x86_64_64bit"  # Regular sixtrack
#SixExe="/afs/cern.ch/user/h/hgarciam/SixTrack/SixTrack/SixTrack_cmakesix_COLLIMAT_DATAMODS_HUGENPART_STF_NOCRLIBM_defaultcompiler_defaultbuildtype/SixTrack_4610_hugenpart_datamods_stf_collimat_fast_tilt_cmake_Linux_gfortran_static_x86_64_64bit" # HEIGENPART sixtrack
...
HTCONDORtemplate="/afs/cern.ch/user/h/hgarciam/scratch0/off_momentum_studies/LHC_2017_off_momentum_cleaning/B1_cleaning_IR3/test/htcondor.sub"
...
# ---------------------------------------------------------------------------------------------------
# Generate initial distribution at collimator
#python myDist.py
python myDistReal.py
# ---------------------------------------------------------------------------------------------------
